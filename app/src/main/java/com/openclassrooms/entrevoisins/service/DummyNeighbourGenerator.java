...
public abstract class DummyNeighbourGenerator {
    ...
    public static List<Neighbour> DUMMY_NEIGHBOURS = Arrays.asList(
            new Neighbour(1, "Jacqueline", "http://i.pravatar.cc/150?u=a042581f4e29026704d",false),
            ...
            new Neighbour(13, "Ajavon", "http://i.pravatar.cc/150?u=a042581f3e39026702d",false)
    );
